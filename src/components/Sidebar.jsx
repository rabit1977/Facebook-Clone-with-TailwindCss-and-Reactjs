  ...
  return (
    <>
      <div className='flex flex-col max-w-xs w-full'>
        <div className='flex-1 max-w-xs hover:border-r-8 border-r-8 border-r-transparent  hover:border-[#7B7B7B]/60 xl:block hidden  -mt-2 py-4'>
          <ul>
        ...
        <div className='flex-1 max-w-xs hover:border-r-8 border-r-8 border-r-transparent  hover:border-[#7B7B7B]/60 xl:block hidden  -mt-2 py-1'>
          <ul>
